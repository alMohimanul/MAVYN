...
def test_imports():
    ...
    from RAVYN.core.extractor import MetadataExtractor
    from RAVYN.core.organizer import FileOrganizer
    from RAVYN.db.repository import Repository
    from RAVYN.db.models import Paper
    from RAVYN.embeddings.encoder import EmbeddingEncoder
    from RAVYN.embeddings.search import SemanticSearchIndex
...
def test_extract_paper_id_from_question():
    from RAVYN.llm.question_parser import extract_paper_ids
...
def test_wants_similar_papers():
    from RAVYN.llm.question_parser import wants_similar_papers
...
def test_arxiv_client_helpers():
    from RAVYN.integrations.arxiv_client import (
        normalize_arxiv_id,
